...
/**
 * This interface represents a general Polynom: f(x) = a<sub>0</sub>x^b<sub>0</sub> + a<sub>1</sub>x^b<sub>1</sub> + a<sub>2</sub>x^b<sub>2</sub> + ...  + a<sub>n</sub>x^b<sub>n</sub>,
 * where: a<sub>0 .. n</sub> are real numbers and a<sub>0 .. n</sub>=0 are none negative integers (naturals)
